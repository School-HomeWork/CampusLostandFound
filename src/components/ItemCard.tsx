    ...
    <Pressable onPress={onPress}>
      <View style={styles.card}>
        <View style={styles.header}>
          <Text style={styles.typeText}>{item.type === 'lost' ? '❌ Lost Item' : '✅ Found Item'}</Text>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.row}>
            ...
            <View style={[
              ...
              <Text style={[styles.badgeText, { color: item.status === 'active' ? colors.primary : colors.secondary }]}>
